(function (ng) {
    ...
    mod.controller("booksCtrl", ["$scope", "bookService", "$modal", "authorService",'$state', '$stateParams', function ($scope, svc, $modal, authorSvc, $state, $stateParams) {
            $scope.currentRecord = {};
            $scope.records = [];
            $scope.refName = "books";
            $scope.alerts = [];
            ...
            authorSvc.getBooks($stateParams.aid).then(function (response) 
